// ENS NameWrapper contract addresses and ABI
// Reference: https://docs.ens.domains/wrapper/overview
...
export const NAME_WRAPPER_ADDRESS: Record<number, Address> = {
  1: '0xD4416b13d2b3a9aBae7AcD5D6C2BbDBE25686401', // Mainnet
  5: '0x114D4603199df73e7D157787f8778E21fCd13066', // Goerli
  11155111: '0x0635513f179D50A207757E05759CbD106d7dFcE8', // Sepolia
} as const

export function getWrapperContract(chainId: number): WrapperContract {
  const address = NAME_WRAPPER_ADDRESS[chainId]
  if (!address) {
    throw new Error(`NameWrapper not deployed on chain ${chainId}`)
  }
